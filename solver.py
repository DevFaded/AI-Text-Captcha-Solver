...
def solve(path):
    ...
    prompt = ("You are a precise OCR assistant. Extract and return only the exact characters shown in this CAPTCHA image, without any extra formatting or commentary.")
    start = time.time()
